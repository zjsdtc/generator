 ...
 * mybatis代码生成器
 */
public class CodeGeneratorForEdu {
    ...
    private static final String[] TABLES = new String[]{"edu_user"};
    private static final String PARENT_PACKAGE = "cn.edu";//父包名
    private static final String[] TABLE_PRE_FIX = new String[]{""};//表前缀


    private static final String DS_URL = "jdbc:mysql://121.37.253.88/edu?serverTimezone=GMT%2B8&characterEncoding=UTF-8";
    private static final String DS_USERNAME = "root";
    private static final String DS_PASSWORD = "edu123456";
